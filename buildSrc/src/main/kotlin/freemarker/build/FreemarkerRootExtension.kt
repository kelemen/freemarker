...
// The Gradle test runner requires Java 8+
private const val MINIMUM_TEST_JAVA_VERSION = "8"
...
class FreemarkerModuleDef internal constructor(
    ...
    fun enableTests(preferredTestJavaVersion: String = compilerVersion.toString()) {
        ...
        target.apply {
            testTask.configure {
                ...
                javaLauncher.set(context.javaToolchains.launcherFor {
                    languageVersion.set(maxOf(testRunnerJavaVersion, JavaLanguageVersion.of(MINIMUM_TEST_JAVA_VERSION)))
                })
            }
